    ...
    return (
        <div className="flex flex-col min-h-screen align-items-center justify-content-center background-image">
            <div className="flex flex-col items-center justify-center flex-1 w-full max-w-[500px]">
                {!showForgotPassword && !isSend && !showSignUp && (
                    <div className="w-full px-3 mx-3 card md:px-7">
                        ...
                        <div className="mt-4">
                            <Button 
                                ...
                                className="w-full !rounded-full py-3 text-[16px] bg-white text-primary border-2 border-primary hover:bg-gray-50" 
                        ...
                        <div className="mt-4 text-center">
                            <p className="text-sm">
                                ...
                                <span className="font-semibold cursor-pointer text-primary" onClick={() => setShowSignUp(true)}>
                                    Sign up now
                                </span>
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/admin" className="m-0 text-sm font-semibold cursor-pointer text-link">Admin Access</Link>
                        </div>
                    </div>
                )}
                {showSignUp && (
                    <div className="w-full px-3 mx-3 card md:px-7">
                        ...
                        <div>
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    className={classNames(signUpErrors.name ? 'p-invalid' : '', 'w-full')} 
                            ...
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    className={classNames(signUpErrors.email ? 'p-invalid' : '', 'w-full')} 
                                    onKeyDown={onSignUpEnter} 
                                />
                            ...
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    className={classNames(signUpErrors.username ? 'p-invalid' : '', 'w-full')} 
                                    onKeyDown={onSignUpEnter} 
                                />
                            ...
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    className={classNames(signUpErrors.signUpPassword ? 'p-invalid' : '', 'w-full')} 
                                    onKeyDown={onSignUpEnter} 
                                />
                                <small className="p-error">{signUpErrors.signUpPassword}</small>
                            </div>
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    className={classNames(signUpErrors.confirmPassword ? 'p-invalid' : '', 'w-full')} 
                                    onKeyDown={onSignUpEnter} 
                                />
                            ...
                            <div className="w-full mb-4">
                                ...
                                <InputText 
                                    ...
                                    onChange={(e) => setSignUpData({...signUpData, aboutMe: e.target.value})} 
                                    className="w-full" 
                                    onKeyDown={onSignUpEnter} 
                                />
                            </div>
                        ...
                        <div className="mt-7">
                            <Button label="Create Account" className="w-full !rounded-full py-3 text-[16px]" onClick={signUp} loading={loading}></Button>
                        </div>
                        <div className="mt-4 text-center">
                            <p className="text-sm">
                                Already have an account?{' '}
                                <span className="font-semibold cursor-pointer text-primary" onClick={() => setShowSignUp(false)}>
                                    Sign in
                                </span>
                            </p>
                        </div>
